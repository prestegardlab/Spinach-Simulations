...
% and an relaxation matrix simulated externally. This version observes the
% spin at the center of the cluster inverting each of the other spins.
% This is based on an initial 2-spin NOE script by: 
% i.kuprov@soton.ac.uk
% Modified by J. Prestegard 12/31/19 03/17/20 06/25/20

%%function noe_spin_cluster_JHP_7()
% Identify EXCEL work book and sheet containing info for Spinach simulation
filename = 'Sucrose_opc_H1_6spin_2k-3kns_2ps_IK6_24w_auto.xlsx';
sheetname = 'Output';
% Name of Relaxation matrix to be used - and name of variable
R_name = 'Sucrose_opc_H1_6spin_2k-3kns_2ps_IK6_24w_R_gce.mat';
Var_name = 'R_gce';
